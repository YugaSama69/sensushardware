...
DROP TABLE IF EXISTS monitoring_master_petugas;
DROP TABLE IF EXISTS monitoring_master_ruangan;
...
CREATE TABLE monitoring_master_ruangan (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE monitoring_master_petugas (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
INSERT INTO monitoring_master_ruangan (nama_ruangan, lokasi, status_aktif) VALUES
...
INSERT INTO monitoring_master_petugas (nama_lengkap, nip_nik, jabatan, status_aktif) VALUES
